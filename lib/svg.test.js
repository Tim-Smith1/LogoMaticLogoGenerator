...
const Shape = require("../utils/Shapes")
...
test("should include a shape", () => {
  const expectedSvg =
    '<svg version="1.1" width="300" height="200" xmlns="http://www.w3.org/2000/svg">[object Object]<text x=\"150\" y=\"125\" font-size=\"60\" text-anchor=\"middle\" fill=\"#333\">SVG</text></svg>'
  const svg = new SVG();
  svg.setText("SVG", "#333");
